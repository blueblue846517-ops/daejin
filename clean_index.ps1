...
$finalContent = $idxTop + $portCommon + $indexScript.Split("`n").Replace("`r", "")
Set-Content -Path ".\index.html" -Value $finalContent -Encoding UTF8
Write-Host "Index.html cleaned and restored completely!"
