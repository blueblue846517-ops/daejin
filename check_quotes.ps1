...
try {
    Invoke-RestMethod -Uri "https://ymgcvcmnwisszabcyisg.supabase.co/rest/v1/quotes?select=*&order=created_at.desc&limit=3" -Method Get -Headers $headers | ConvertTo-Json -Depth 5
} catch {
